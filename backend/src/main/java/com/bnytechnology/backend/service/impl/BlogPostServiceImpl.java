...
import com.bnytechnology.backend.mapper.BlogPostMapper;
import com.bnytechnology.backend.repository.BlogPostRepository;
...
@SuppressWarnings("null")`npublic class BlogPostServiceImpl implements BlogPostService {
    ...
    public BlogPostResponse create(BlogPostRequest request) {
        BlogPost entity = mapper.toEntity(request);
    ...
    public BlogPostResponse update(Long id, BlogPostRequest request) {
        ...
        BlogPost updated = mapper.toEntity(request);
        updated.setId(id);
