...
import com.bnytechnology.backend.mapper.TestimonialMapper;
import com.bnytechnology.backend.repository.TestimonialRepository;
...
public class TestimonialServiceImpl implements TestimonialService {
    ...
    @Override
    @Transactional(readOnly = true)
    public TestimonialResponse findById(Long id) {
    ...
    public TestimonialResponse create(TestimonialRequest request) {
        Testimonial entity = mapper.toEntity(request);
    ...
    public TestimonialResponse update(Long id, TestimonialRequest request) {
        ...
        Testimonial updated = mapper.toEntity(request);
        updated.setId(id);
