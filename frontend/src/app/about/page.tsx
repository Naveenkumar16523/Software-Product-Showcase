    ...
    <div className="bg-background min-h-screen pt-20 pb-24">
      ...
      <div className="bg-primary-900 text-white py-24 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-6">Building the Future of Retail</h1>
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-6xl -mt-10 relative z-10">
        ...
        {/* Story & Vision */}
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-soft border border-border mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((val, i) => (
              <div key={i} className="bg-surface p-6 rounded-2xl border border-border">
                <div className="w-10 h-10 bg-primary-100 text-primary-600 rounded-full flex items-center justify-center font-bold mb-4">0{i+1}</div>
        ...
        <div id="leadership" className="mb-24 pt-10">
          <h2 className="text-3xl font-display font-bold text-center text-gray-900 mb-12">Leadership Team</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {leaders.map((leader, i) => (
              <div key={i} className="bg-white rounded-2xl border border-border overflow-hidden group">
                <div className="h-64 bg-gray-200 flex items-center justify-center text-4xl font-bold text-gray-400 group-hover:bg-primary-50 transition-colors">
                  {leader.img}
                </div>
                <div className="p-6">
                  <h3 className="text-xl font-bold text-gray-900">{leader.name}</h3>
                  <div className="text-primary-600 font-semibold text-sm mb-4">{leader.role}</div>
                  <p className="text-gray-600 text-sm mb-6 line-clamp-3">{leader.bio}</p>
                  <a href="#" className="inline-flex text-gray-400 hover:text-primary-600 transition-colors">
        ...
        {/* Awards Timeline */}
        <div className="mb-24 bg-surface rounded-3xl p-8 md:p-12 border border-border">
          <h2 className="text-3xl font-display font-bold text-center text-gray-900 mb-12">Awards & Recognition</h2>
          <div className="space-y-8 max-w-3xl mx-auto">
            {awards.map((award, i) => (
              <div key={i} className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-8 bg-white p-6 rounded-2xl border border-border shadow-sm">
                <div className="text-2xl font-bold text-primary-300">{award.year}</div>
        ...
        {/* Offices */}
        <div>
          <h2 className="text-3xl font-display font-bold text-center text-gray-900 mb-12">Global Offices</h2>
          <div className="bg-white rounded-2xl border border-border overflow-hidden flex flex-col md:flex-row shadow-sm">
            <div className="md:w-1/2 p-8 md:p-12">
              <div className="mb-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Chennai Headquarters</h3>
                <p className="text-gray-500 font-medium">B & Y Technology</p>
              </div>
              <ul className="space-y-6">
                <li className="flex gap-4">
                  <MapPin className="w-6 h-6 text-primary-600 shrink-0" />
                  <span className="text-gray-700">No.624, Khivraj Building, Anna Salai,<br/>Chennai-600006<br/>LM.Gemini Flyover</span>
                </li>
                <li className="flex gap-4">
                  <Phone className="w-6 h-6 text-primary-600 shrink-0" />
                  <div>
                    <a href="tel:+919941070555" className="block text-gray-700 hover:text-primary-600">+91 99410 70555</a>
                    <a href="tel:+918667735575" className="block text-gray-700 hover:text-primary-600 mt-1">+91 86677 35575</a>
                  </div>
                </li>
                <li className="flex gap-4">
                  <Mail className="w-6 h-6 text-primary-600 shrink-0" />
                  <a href="mailto:info@bnytechnologies.com" className="text-gray-700 hover:text-primary-600">info@bnytechnologies.com</a>
                </li>
              </ul>
            </div>
            <div className="md:w-1/2 bg-gray-200 min-h-[300px] relative">
               <div className="absolute inset-0 flex items-center justify-center bg-gray-100 text-gray-400 font-bold text-xl border-l border-border">
