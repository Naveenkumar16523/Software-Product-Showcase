        ...
        <div className="mt-12 bg-surface border border-border p-8 rounded-xl shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <form className="flex w-full md:w-auto gap-2" onSubmit={(e) => e.preventDefault()}>
            <input 
              ...
              required 
            />
            <button type="submit" className="px-6 py-2 bg-brand-accent hover:bg-brand-accent/90 text-black font-medium rounded-md transition-colors shadow-[0_0_10px_rgba(163,230,53,0.3)] hover:shadow-[0_0_15px_rgba(163,230,53,0.5)]">
              Subscribe
            </button>
          </form>
        </div>
